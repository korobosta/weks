<?php 
	...
	if(mysqli_num_rows($check_repetition)>0){
		...
		$sql = "UPDATE registered_units SET unit='$unit',student='$student',marks='$marks', date_updated='$date_uploaded',cat_marks='$cat_marks',main_exam_marks='$main_exam_marks' WHERE id='$id'";
		mysqli_query($conn, "INSERT into history_log (transaction,user_id,date_added) 
