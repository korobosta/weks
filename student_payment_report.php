<?php session_start(); 
$user_id=$_SESSION['ID'];
$student=$conn->query("SELECT students.REGISTRATION_NUMBER,students.STUDENT_ID,students.PROGRAM,program.PROGRAM FROM students JOIN program ON students.PROGRAM=program.PROGRAM_ID where students.USER='$user_id'");
if(!$student){
  echo $conn->error;
}
  ...
  <div class="container">
    ...
    <div class="col-md-8" id="stud" style="padding:50px">   
     ...
     <hr>
      ...
      <hr>
     <?php 
      $sy=$conn->query("SELECT  DISTINCT payments.school_year from payments WHERE payments.student='$student_id'");
